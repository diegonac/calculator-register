...
const generatePDF = (sums: SumsHooks["sums"], total: SumsHooks["total"], saleCondition: string) => {
    
    const docDefinition: TDocumentDefinitions = {
        content: [
            { text: showDate(), style: "date" },
            { text: "Detalle:", style: "title"},
            { text: `Condición de la venta: ${saleCondition.toLowerCase()}`, style: "saleCondition"},
